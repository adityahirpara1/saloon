! function(e) {
    ...
    e(".vs-carousel").each((function() {
        ...
        e("[data-slick-next]").each((function() {
            ...
            vertical: !!t("vertical"),
            prevArrow: t("prev-arrow") ? o : '<button type="button" class="slick-prev"><i class="long-arrow"></i></button>',
            nextArrow: t("next-arrow") ? r : '<button type="button" class="slick-next"><i class="long-arrow"></i></button>',
